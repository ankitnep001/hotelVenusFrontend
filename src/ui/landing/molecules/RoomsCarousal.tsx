        ...
        <div className="relative flex flex-col justify-center gap-y-10 w-full ">
            <div className="flex flex-col md:flex-row px-20  items-center">
                <div className="flex-1">
                    {/* Room Image */}
                    <img src={rooms[activeIndex].roomImage} alt={rooms[activeIndex].name} className="w-96 md:w-full h-80 object-cover" />
                </div>
            ...
            <button onClick={handlePrev} className="absolute top-1/2 left-3 transform -translate-y-1/2 text-[#4f2f1f] px-2 py-1">
                <GoChevronLeft size={30} />
            </button>
            <button onClick={handleNext} className="absolute top-1/2 right-3 transform -translate-y-1/2  text-[#4f2f1f] px-2 py-1">
