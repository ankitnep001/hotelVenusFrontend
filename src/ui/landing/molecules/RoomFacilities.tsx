    ...
    return (
        <div className="flex flex-col md:flex-row gap-x-10 px-10 bg-[#f6e6d6] w-full py-20">
            ...
            <div className="flex flex-col justify-center w-full gap-y-5">
                <h1 className="flex justify-center  w-full font-nanum text-[#5b3423] mt-[90px] text-[55px] md:text-[66px]">Facilities</h1>
                ...
                <button className="flex justify-center w-full uppercase font-poppins text-[12px] text-[#4F2F1F] border-2 border-[#4f2f1f] px-3 py-2 hover:bg-[#4f2f1f] hover:text-[#fffcf1] max-w-[123px] mt-5">
                    book now
                </button>
            </div>
        </div>
