export const adminSidebar = [
    ...
    { id: 3, label: 'Posts', route: '/admin/posts', title: '' },
    { id: 4, label: 'Rooms', route: '/admin/rooms', title: 'Rooms' },
    { id: 5, label: 'Pages', route: '/admin/pages', title: 'Pages' },
    { id: 6, label: 'Features', route: '/admin/features', title: 'Features' },
    { id: 7, label: 'Services', route: '/admin/services', title: 'Services' },
    { id: 8, label: 'Inquiry', route: '/admin/inquiry', title: 'Inquiry' },
    { id: 9, label: 'Settings', route: '/admin/setting', title: 'Settings' },
